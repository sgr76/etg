...
class GeneratorFactoryStd : public GeneratorFactory
{
protected:
    GeneratorFactoryStd (const GeneratorFactoryStd &) = delete;

    GeneratorFactoryStd & operator = (const GeneratorFactoryStd &) = delete;
...
private:
    ...
    static GeneratorRegistration<GeneratorFactoryStd> factory;
};

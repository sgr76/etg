...
EtgEnumQt5::EtgEnumQt5 (const clang::EnumDecl * ed)
    : EtgEnum(ed)
{
}
 ...
 * @return TODO
 */
void EtgEnumQt5::generateNames (std::ofstream & out)
{
    bool first = true;
 ...
 * @return TODO
 */
void EtgEnumQt5::generateTexts (std::ofstream & out)
{
    bool first = true;
 ...
 * @return TODO
 */
void EtgEnumQt5::generateValues (std::ofstream     & out,
 ...
 * @return TODO
 */
void EtgEnumQt5::generateTranslates (std::ofstream & out)
{
}

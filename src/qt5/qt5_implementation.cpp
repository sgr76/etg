...
EtgImplementationQt5::EtgImplementationQt5 (const std::string _filename)
    : EtgImplementation(_filename)
{
}


void EtgImplementationQt5::generate ()
{
...
void EtgImplementationQt5::generateMethods_Exception_InvalidValue (std::ofstream                  & out,
...
void EtgImplementationQt5::generateMethods_ExceptionDefault (std::ofstream                  & out,
                                                             const std::shared_ptr<EtgEnum> & _enum,
                                                             const std::string              & scope,
                                                             const std::string              & fqEnum)
{

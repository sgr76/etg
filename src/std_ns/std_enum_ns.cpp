...
EtgEnumStdNs::EtgEnumStdNs (const clang::EnumDecl * ed)
    : EtgEnum(ed)
{
}
 ...
 * @return TODO
 */
void EtgEnumStdNs::generateNames (std::ofstream & out)
{
    bool first = true;
 ...
 * @return TODO
 */
void EtgEnumStdNs::generateTexts (std::ofstream & out)
{
    bool first = true;
 ...
 * @return TODO
 */
void EtgEnumStdNs::generateValues (std::ofstream     & out,
 ...
 * @return TODO
 */
void EtgEnumStdNs::generateTranslates (std::ofstream & out)
{
}
